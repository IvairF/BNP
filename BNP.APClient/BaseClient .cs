...
namespace BNP.APClient
{
    public class BaseClient
    {
        ...
        public BaseClient()
            : this(ConfigurationManager.AppSettings["CaminhoAppBNPApi"], null)
        {
        ...
        public BaseClient(HttpSessionStateBase session)
            : this(ConfigurationManager.AppSettings["CaminhoBNPApi"], session)
        {
            ...
            where TResult : new()
        {
            ...
            else if (response.StatusCode != HttpStatusCode.OK)
            {
                ...
                if (((response.Data as BNP.DTO.BaseDTO) != null) && ((response.Data as BNP.DTO.BaseDTO).Mensagem != ""))
                {
                    ex = new Exception((response.Data as BNP.DTO.BaseDTO).Mensagem);
                }
